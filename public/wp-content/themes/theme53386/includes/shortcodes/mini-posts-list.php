				...
				$format         = get_post_format();
					...
					if ($meta == 'yes') {
						...
						$output .= '<div class="mini-post-meta">';
							$output .= '<time datetime="'.get_the_time('Y-m-d\TH:i:s', $post->ID).'"> <span class="day">' .get_the_time('d', $post->ID). '</span><span class="month">' .get_the_time('M', $post->ID). '</span></time>';
						$output .= '</div>';
					}
					...
					if ($thumbs != 'none') {
						...
						$output .= '<div class="mini-post-content">';
							...
							if ($meta == 'yes') {
								// mini post meta
								$output .= '<div class="mini-post-meta-category">';
									// post category
