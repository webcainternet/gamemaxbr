...
class My_SocialNetworksWidget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<?php foreach(array("Facebook", "Twitter", "Flickr", "Github", "Rss", "Delicious", "Linkedin", "Google_plus") as $network) : ?>
...
?>
	...
	<p><label for="<?php echo $this->get_field_id('github'); ?>"><?php echo 'Github:' ?></label>
	...
	<p><label for="<?php echo $this->get_field_id('github_label'); ?>"><?php echo 'Github '.theme_locals("label") ?></label>
